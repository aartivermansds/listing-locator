...
class AmenitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create amenity" do
    assert_difference('Amenity.count') do
      post amenities_url, params: { amenity: { icon_type: @amenity.icon_type, name: @amenity.name } }
    end
  ...
  test "should update amenity" do
    patch amenity_url(@amenity), params: { amenity: { icon_type: @amenity.icon_type, name: @amenity.name } }
