class Admins::PlaceCategoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @place_category.save
        format.html { redirect_to admins_place_category_path(@place_category), notice: 'Place category was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @place_category.update(place_category_params)
        format.html { redirect_to admins_place_category_path(@place_category), notice: 'Place category was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admins_place_categories_url, notice: 'Place category was successfully destroyed.' }
  ...
  private
    ...
    def place_category_params
      params.require(:place_category).permit(:name, :description, :banner_image)
    end
end
